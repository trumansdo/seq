...
public class SeqTest {
  ...
  public void testChunked() {
    ...
    Function<ArrayListZeroFlow<Integer>, String> function = s -> s.join(",");
  ...
  public void testReducer() {
    ...
    assertTo(seq.reduce(Reducer.filtering(Objects::nonNull, Reducer.mapping(Object::toString)))
        , "1,2,3,4");
    MapZeroFlow<String, MapZeroFlow<String, ArrayListZeroFlow<Stud>>> stringMapSeqMapSeq = ZeroFlow.of(
            new Stud("一年级", "1班", "张三"),
            new Stud("一年级", "1班", "李四"),
            new Stud("二年级", "1班", "王五"),
            new Stud("三年级", "1班", "赵六")
